...
/*java后台存储公钥私钥*/
    ...
    public static void test() throws Exception {
        /*java后台存储公钥私钥*/
        String pukey = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQClVNJfuTWsDavS2byXsmPEBwFsFtjhA2QTI/RF" +
        ...
        String prkey = "MIICeAIBADANBgkqhkiG9w0BAQEFAASCAmIwggJeAgEAAoGBAKVU0l+5NawNq9LZvJeyY8QHAWwW" +
        ...
        data.put("identifyCode","理财专员110");
        data.put("scalperId","34");
        data.put("scalperInfoId","15");
        data.put("fixqrs","[{\"amount\":19.91,\"pictureUrl\":\"HTTPS://QR.ALIPAY.COM/FKX07107TOG0GZXMSAT0AC\"}]");
...
//        String signatureStr = signString(str,prkey);
        ...
        System.out.println("*****************************");
        /*前端生成签名*/
        boolean b = verify(str,pukey,"");
        System.out.print("iii   " + b);
